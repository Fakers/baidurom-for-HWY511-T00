...
#-----------------------------------------------------------------------------
vendor_saved_apps := MtkBt Stk1 StkSelection EngineerMode EngineerModeSim MediaProvider
...
#-----------------------------------------------------------------------------
vendor_modify_apps := FMRadio Settings 
...
# add by Fakers
override_property += \
    ro.baidu.romer=红旗_Real \
    ro.build.display.id=511_R_2.3.53.41 \
    ro.build.version.incremental=511_R_2.3.53.41 \
    ro.custom.build.version=511_R_2.3.53.41 \
    ro.build.version.release=4.2.2 \
    ro.build.tags=fakers-keys \
    ro.build.description=Y511-T00-user 4.2.2 HUAWEIY511-T00 C112B169 fakers-keys \
    ro.build.fingerprint=HUAWEI/Y511-T00/HWY511-T:4.2.2/HUAWEIY511-T00/C112B169:user/fakers-keys \
