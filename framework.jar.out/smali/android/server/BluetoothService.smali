...
.method static synthetic access$1100(Landroid/server/BluetoothService;)Landroid/server/BluetoothService$UserSwitchedHandler;
    .locals 1
    .parameter "x0"
...
.method private updateCountersAndCheckForConnectionStateChange(II)Z
    ...
    const-string/jumbo v4, "updateCountersAndCheckForConnectionStateChange: prevState = "
    ...
    const-string v4, "Before: mProfilesConnecting = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Landroid/server/BluetoothService;->mProfilesConnecting:I
    ...
    iget v4, p0, Landroid/server/BluetoothService;->mProfilesDisconnecting:I
    ...
    const-string v2, "-After: mProfilesConnecting = "
    ...
    const-string/jumbo v2, "updateCountersAndCheckForConnectionStateChange: ret = "
    ...
    .line 3047
    :pswitch_0
    iget v3, p0, Landroid/server/BluetoothService;->mProfilesConnecting:I
    ...
    .line 3056
    :pswitch_1
    iget v3, p0, Landroid/server/BluetoothService;->mProfilesConnected:I
    ...
    .line 3065
    :pswitch_2
    iget v3, p0, Landroid/server/BluetoothService;->mProfilesDisconnecting:I
...
.method private updateProfileConnectionState(III)V
    ...
    const-string v6, "Update: currHashState = "
...
.method getPersistedBluetoothState()Z
    .locals 5
    ...
    .line 2063
    .local v1, persistedBluetoothState:I
    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "getPersistedBluetoothState: persistedBluetoothState = "
...
.method persistBluetoothState(Z)V
    .locals 5
    .parameter "isBtOn"
    ...
    const-string/jumbo v3, "persistBluetoothState: isBtOn = "
    ...
    const-string v4, "bluetooth_state"
