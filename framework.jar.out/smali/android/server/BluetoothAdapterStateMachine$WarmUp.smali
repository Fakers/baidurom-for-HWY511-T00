...
.method public enter()V
    ...
    invoke-static {v1}, Landroid/server/BluetoothAdapterStateMachine;->access$3000(Landroid/server/BluetoothAdapterStateMachine;)Landroid/os/Message;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v3}, Landroid/server/BluetoothAdapterStateMachine;->access$3100(Landroid/server/BluetoothAdapterStateMachine;I)V
    ...
    invoke-static {v2, v3}, Landroid/server/BluetoothAdapterStateMachine;->access$3300(Landroid/server/BluetoothAdapterStateMachine;Lcom/android/internal/util/IState;)V

    .line 365
    iget-object v2, p0, Landroid/server/BluetoothAdapterStateMachine$WarmUp;->this$0:Landroid/server/BluetoothAdapterStateMachine;

    #getter for: Landroid/server/BluetoothAdapterStateMachine;->mDelayBroadcastStateOff:Z
    invoke-static {v2}, Landroid/server/BluetoothAdapterStateMachine;->access$3400(Landroid/server/BluetoothAdapterStateMachine;)Z
    ...
    invoke-static {v2, v1}, Landroid/server/BluetoothAdapterStateMachine;->access$3402(Landroid/server/BluetoothAdapterStateMachine;Z)Z
    ...
    invoke-static {v1, p1}, Landroid/server/BluetoothAdapterStateMachine;->access$3700(Landroid/server/BluetoothAdapterStateMachine;Landroid/os/Message;)V
