...
.method private endFile(Landroid/media/MediaScanner$FileEntry;ZZZZZ)Landroid/net/Uri;
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1100(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1200(Landroid/media/MediaScanner;)Landroid/media/MediaInserter;
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1300(Landroid/media/MediaScanner;)Landroid/net/Uri;
    ...
    .line 1106
    .local v21, needToSetSettingsGemini:Z
    const-wide/16 v33, 0x0
    ...
    #getter for: Landroid/media/MediaScanner;->mMtpObjectHandle:I
    invoke-static/range {v34 .. v34}, Landroid/media/MediaScanner;->access$600(Landroid/media/MediaScanner;)I
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1600(Landroid/media/MediaScanner;)Z
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1700(Landroid/media/MediaScanner;)Z
    ...
    :cond_c
    const-string/jumbo v33, "notification_set"
    ...
    #getter for: Landroid/media/MediaScanner;->mDefaultNotificationFilename:Ljava/lang/String;
    invoke-static/range {v34 .. v34}, Landroid/media/MediaScanner;->access$1800(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    const-string v34, "endFile: needToSetNotification=true."

    invoke-static/range {v33 .. v34}, Lcom/mediatek/xlog/Xlog;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$2500(Landroid/media/MediaScanner;)Landroid/content/IContentProvider;
    ...
    const-string/jumbo v33, "pre_set_notification_sound"
    ...
    invoke-static/range {v33 .. v34}, Landroid/media/MediaScanner;->access$1702(Landroid/media/MediaScanner;Z)Z
    ...
    const-string v35, "endFile: set notification. uri="
    ...
    const-string/jumbo v33, "ringtone_set_gemini"
    ...
    const-string/jumbo v33, "ringtone_gemini"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Landroid/media/MediaScanner$MyMediaScannerClient;->setProfileSettingsGemini(ILandroid/net/Uri;J)V
    ...
    #setter for: Landroid/media/MediaScanner;->mDefaultRingtoneSetGemini:Z
    ...
    const-string v35, "endFile: set ringtone gemini. uri="
    ...
    .end local v21           #needToSetSettingsGemini:Z
    ...
    const-class v33, Lcom/mediatek/common/mpodecoder/IMpoDecoder;
    ...
    invoke-static/range {v33 .. v34}, Lcom/mediatek/common/MediatekClassFactory;->createInstance(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v19, mpoType:I
    const-string/jumbo v33, "mpo_type"
    ...
    :cond_1a
    const-string/jumbo v33, "stereo_type"
    ...
    const-class v33, Lcom/mediatek/common/stereo3d/IJpsParser;
    ...
    check-cast v23, Lcom/mediatek/common/stereo3d/IJpsParser;

    .local v23, parser:Lcom/mediatek/common/stereo3d/IJpsParser;
    if-eqz v23, :cond_20

    invoke-interface/range {v23 .. v23}, Lcom/mediatek/common/stereo3d/IJpsParser;->getLayout()I
    ...
    .end local v23           #parser:Lcom/mediatek/common/stereo3d/IJpsParser;
    :catch_0
    move-exception v7
    ...
    const-string v34, "endFile: Null ExifInterface!"
    ...
    const-string v34, "endFile: Null MpoDecoder!"
    ...
    .restart local v23       #parser:Lcom/mediatek/common/stereo3d/IJpsParser;
    :cond_1e
    const/16 v33, 0x3
    ...
    const-string v35, "endFile: unexpected jps layout:"
    ...
    const-string v34, "endFile:parser==null set jps default layout side by side."
    ...
    .restart local v21       #needToSetSettingsGemini:Z
    ...
    invoke-static/range {v33 .. v33}, Landroid/media/MediaScanner;->access$1900(Landroid/media/MediaScanner;)Z
    ...
    :cond_24
    const-string/jumbo v33, "ringtone_set"
    ...
    #getter for: Landroid/media/MediaScanner;->mDefaultRingtoneFilename:Ljava/lang/String;
    invoke-static/range {v34 .. v34}, Landroid/media/MediaScanner;->access$2000(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    const-string v34, "endFile: needToSetRingtone=true."
    ...
    #getter for: Landroid/media/MediaScanner;->mDefaultRingtoneSetGemini:Z
    ...
    #getter for: Landroid/media/MediaScanner;->mDefaultRingtoneFilenameGemini:Ljava/lang/String;
    ...
    const-string v34, "endFile: needToSetRingtoneGemini=true."
    ...
    const-string v34, "endFile: needToSetAlarm=true."
    ...
    const-string/jumbo v33, "pre_set_ringtone"
    ...
    const-string/jumbo v33, "video_call"
    ...
    invoke-static/range {v33 .. v34}, Landroid/media/MediaScanner;->access$1902(Landroid/media/MediaScanner;Z)Z
    ...
    const-string v35, "endFile: set ringtone. uri="
    ...
    const-string/jumbo v33, "pre_set_alarm_alert"
...
.method private setProfileSettingsGemini(ILandroid/net/Uri;J)V
    .locals 1
    .parameter "type"
    .parameter "uri"
    .parameter "rowId"
    ...
    const-string/jumbo v0, "mtk_audioprofile_default_ringtone_gemini"
