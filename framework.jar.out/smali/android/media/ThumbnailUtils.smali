...
.method public static createImageThumbnail(Ljava/lang/String;I)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v9, v14}, Landroid/media/ThumbnailUtils$SizedThumbnailBitmap;-><init>(Landroid/media/ThumbnailUtils$1;)V
    ...
    invoke-static {v0, v12, v6, v9}, Landroid/media/ThumbnailUtils;->createThumbnailFromEXIF(Ljava/lang/String;IILandroid/media/ThumbnailUtils$SizedThumbnailBitmap;)V
    ...
    invoke-static {v3, v14, v8}, Landroid/graphics/BitmapFactory;->decodeFileDescriptor(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    .line 134
    iget-boolean v14, v8, Landroid/graphics/BitmapFactory$Options;->mCancel:Z
    ...
    :cond_8
    :try_start_3
    invoke-static {v8, v12, v6}, Landroid/media/ThumbnailUtils;->computeSampleSize(Landroid/graphics/BitmapFactory$Options;II)I

    move-result v14

    invoke-static {v14, v8}, Landroid/media/ThumbnailUtils;->adustSampleSize(ILandroid/graphics/BitmapFactory$Options;)I
    ...
    iput-boolean v14, v8, Landroid/graphics/BitmapFactory$Options;->inDither:Z
