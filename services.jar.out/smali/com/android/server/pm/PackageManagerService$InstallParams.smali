...
.method private installLocationPolicy(Landroid/content/pm/PackageInfoLite;I)I
    ...
    .line 6569
    :try_start_0
    iget-object v9, p0, Lcom/android/server/pm/PackageManagerService$InstallParams;->this$0:Lcom/android/server/pm/PackageManagerService;

    iget-object v9, v9, Lcom/android/server/pm/PackageManagerService;->mPackages:Ljava/util/HashMap;
    ...
    .line 6574
    iget v9, p1, Landroid/content/pm/PackageInfoLite;->versionCode:I

    iget v10, v5, Landroid/content/pm/PackageParser$Package;->mVersionCode:I
    ...
    const-string v9, "Can\'t install update of "
    ...
    const-string v9, " update version "
    ...
    const-string v9, " is older than installed version "

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v9, v5, Landroid/content/pm/PackageParser$Package;->mVersionCode:I
    ...
    const-string v7, "Cannot install update to system app on sdcard"
    ...
    invoke-static {v5}, Lcom/android/server/pm/PackageManagerService;->access$2400(Landroid/content/pm/PackageParser$Package;)Z
    ...
    :cond_d
    invoke-direct {p0}, Lcom/android/server/pm/PackageManagerService$InstallParams;->isSDExistWhenSwap()Z
    ...
    .line 6658
    :cond_e
    iget v6, p1, Landroid/content/pm/PackageInfoLite;->recommendedInstallLocation:I
...
.method public handleStartCopy()V
    ...
    invoke-static {}, Lcom/android/server/pm/PackageManagerService;->access$3000()Z
