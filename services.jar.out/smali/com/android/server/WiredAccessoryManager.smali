...
.method private updateLocked(Ljava/lang/String;I)V
    ...
    iput v7, p0, Lcom/android/server/WiredAccessoryManager;->illegal_state:I

    .line 245
    const/16 v7, 0x31

    iget v8, p0, Lcom/android/server/WiredAccessoryManager;->illegal_state:I
    ...
    new-instance v8, Lcom/android/server/WiredAccessoryManager$3;

    invoke-direct {v8, p0}, Lcom/android/server/WiredAccessoryManager$3;-><init>(Lcom/android/server/WiredAccessoryManager;)V
    ...
    invoke-virtual {v7, v11, v2, v8, p1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
