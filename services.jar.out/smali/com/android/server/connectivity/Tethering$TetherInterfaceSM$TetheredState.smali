...
.method public processMessage(Landroid/os/Message;)Z
    ...
    const-string v15, "[ISM_Tethered] processMessage what="
    ...
    const-string v15, "[ISM_Tethered] mMyUpstreamIfaceName: "
    ...
    iget-object v13, v0, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM$TetheredState;->this$1:Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;

    iget-object v13, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->this$0:Lcom/android/server/connectivity/Tethering;

    #calls: Lcom/android/server/connectivity/Tethering;->isIpv6MasterSmOn()Z
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$900(Lcom/android/server/connectivity/Tethering;)Z
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mNMService:Landroid/os/INetworkManagementService;
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$2900(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;
    ...
    iget-object v14, v14, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mIfaceName:Ljava/lang/String;

    invoke-interface {v13, v14}, Landroid/os/INetworkManagementService;->untetherInterface(Ljava/lang/String;)V
    ...
    invoke-interface {v13, v14, v15}, Landroid/os/INetworkManagementService;->setDhcpv6Enabled(ZLjava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$800(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$1000(Lcom/android/server/connectivity/Tethering;)Lcom/android/internal/util/StateMachine;
    ...
    iget-boolean v13, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mUsb:Z
    ...
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering;->access$1200(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1600(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mInitialState:Lcom/android/internal/util/State;
    invoke-static {v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2200(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v14

    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3200(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    const-string v15, "[ISM_Tethered] Untethered "
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastErrorAndTransitionToInitialState(I)V
    ...
    invoke-static {v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2000(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v14

    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3300(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    .line 1606
    .local v11, smName:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v15, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED s:"
    ...
    const-string v15, "[ISM_Tethered] IfaceNameSmNames[0]:"
    ...
    const-string v15, " IfaceNameSmNames[1]:"
    ...
    const-string v15, "] CMD_TETHER_CONNECTION_CHANGED mMyUpstreamIfaceName: "
    ...
    const-string v15, ", mMyUpstreamIfaceNameIpv6:"
    ...
    const-string v15, ", newUpstreamIfaceName: "
    ...
    const-string v13, "Ipv6TetherMaster"
    ...
    const-string v14, "[ISM_Tethered] Connection changed noop - dropping"
    ...
    iget-object v13, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceNameIpv6:Ljava/lang/String;
    ...
    const-string v14, "[ISM_Tethered] Connection changed noop - dropping ipv6"
    ...
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering;->access$3402(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    invoke-interface {v13, v14, v7}, Landroid/os/INetworkManagementService;->enableNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v13, v14}, Landroid/os/INetworkManagementService;->setIpForwardingEnabled(Z)V
    ...
    const-string v15, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED enableNat for:"
    ...
    const-string v14, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED updateDns"
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$3500(Lcom/android/server/connectivity/Tethering;)V
    ...
    invoke-static {v14}, Lcom/android/server/connectivity/Tethering;->access$3600(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;

    move-result-object v14

    invoke-interface {v13, v14}, Landroid/os/INetworkManagementService;->setDnsForwarders([Ljava/lang/String;)V
    :try_end_1
    ...
    const-string v14, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED mMyUpstreamIfaceName = null"
    ...
    iput-object v14, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceName:Ljava/lang/String;
    ...
    const-string v15, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED finished!"
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$3900(Lcom/android/server/connectivity/Tethering;)V
    ...
    #calls: Lcom/android/server/connectivity/Tethering;->sendTetherStateChangedBroadcast()V
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$1500(Lcom/android/server/connectivity/Tethering;)V
    ...
    invoke-virtual {v13, v14}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    const-string v14, "interface_throttle_enable"
    ...
    invoke-interface {v13}, Landroid/os/INetworkManagementService;->getBandwidthRxKbps()I
    ...
    invoke-interface {v13}, Landroid/os/INetworkManagementService;->getBandwidthTxKbps()I
    ...
    invoke-interface {v13, v14, v9, v12}, Landroid/os/INetworkManagementService;->setInterfaceThrottle(Ljava/lang/String;II)V
    ...
    const-string v15, "[ISM_Tethered] wifi hotspot bandwidth is enable:"
    ...
    const-string v15, "setInterfaceThrottle failed:"
    ...
    invoke-static {v13}, Lcom/android/server/connectivity/Tethering;->access$1700(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-interface {v13, v14, v7}, Landroid/os/INetworkManagementService;->enableNatIpv6(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v13, v14}, Landroid/os/INetworkManagementService;->setIpv6ForwardingEnabled(Z)V
    :try_end_3
    ...
    const-string v15, "[ISM_Tethered] Exception enabling Nat: "
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$3800(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
    ...
    const-string v15, "[ISM_Tethered] untetherInterface failed, exception: "
    ...
    iput-object v7, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceName:Ljava/lang/String;
    ...
    const-string v14, "[ISM_Tethered] CMD_TETHER_CONNECTION_CHANGED mMyUpstreamIfaceNameIpv6 = null"
    ...
    iput-object v14, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceNameIpv6:Ljava/lang/String;
    ...
    iput-object v7, v13, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->mMyUpstreamIfaceNameIpv6:Ljava/lang/String;
    ...
    .end local v11           #smName:Ljava/lang/String;
    :pswitch_3
    const/4 v6, 0x1
    ...
    const-string v15, "[ISM_Tethered] CMD_TETHER_MODE_DEAD, mMyUpstreamIfaceName: "
    ...
    const-string v15, "[ISM_Tethered] CMD_TETHER_MODE_DEAD, mMyUpstreamIfaceNameIpv6: "
    ...
    const-string v15, "[ISM_Tethered] Tether lost upstream connection "
    ...
    const-string v14, "[ISM_Tethered] sendTetherStateChangedBroadcast in CMD_TETHER_MODE_DEAD of TetheredState"
    ...
    #calls: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$4000(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
